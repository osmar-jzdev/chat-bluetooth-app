...
import dgtic.unam.bluetooth.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.devicesList.setOnItemClickListener { parent, view, position, id ->
            print("Evento......")
            connectToServerThread= ConnectToServerThread(discoveryDevices.get(position),bluetoothAdapter,this)
